 ...
 *
 * Passo-a-passo:
 * 1. Criar um webform com o nome de máquina: indicadores_abcd_2022
 ...
 * 
 * 3. Para rodar e importar os resultados de 2022 insira o código abaixo, atentando para o seu pwd atual:
 *    ./vendor/bin/drush php-script ~/projetos/scripts/drupal/indicadores-abcd/import-to-webform/import-2022.php
 *
*/

$csvArchive = fopen('../../scripts/drupal/indicadores-abcd/data/2022.csv', "r");
...
if ($csvArchive !== FALSE) {
    ...
    while (($data = fgetcsv($csvArchive, 1000, ",")) !== FALSE) {
        ...
        $pedidos_nao_atendidos_nacional_bibliusp,
        $copias_bibliusp,
        ...
        $solicitante_nao_atendidos_nacional_bibliusp,
        ...
        $webform_id = 'indicadores_abcd_2022';
        ...
        $values = [
            ...
            'data' => [
                ...
                'pedidos_nao_atendidos_nacional_bibliusp' => $pedidos_nao_atendidos_nacional_bibliusp,
                'copias_bibliusp' => $copias_bibliusp,
                ...
                'solicitante_nao_atendidos_nacional_bibliusp' => $solicitante_nao_atendidos_nacional_bibliusp,
