...
*
* Passo-a-passo:
* 1. Criar um webform com o nome de máquina: indicadores_abcd_2017
...
* 
* 3. Para rodar e importar os resultados de 2017, insira o código abaixo, atentando para o seu pwd atual:
*    ./vendor/bin/drush php-script ~/projetos/scripts/drupal/indicadores-abcd/import-to-webform/import-2017.php
* 
*/

$csvArchive = fopen('../../scripts/drupal/indicadores-abcd/data/2017.csv', "r");
...
if ($csvArchive !== FALSE) {
    ...
    while (($data = fgetcsv($csvArchive, 1000, ",")) !== FALSE) {
        ...
        $webform_id = 'indicadores_abcd_2017';
